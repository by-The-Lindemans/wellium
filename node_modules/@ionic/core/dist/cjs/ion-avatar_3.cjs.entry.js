...
const Avatar = class {
    ...
    render() {
        return (index.h(index.Host, { key: '998217066084f966bf5d356fed85bcbd451f675a', class: index.getIonMode(this) }, index.h("slot", { key: '1a6f7c9d4dc6a875f86b5b3cda6d59cb39587f22' })));
    }
};
Avatar.style = {
    ios: avatarIosCss,
...
const Thumbnail = class {
    ...
    render() {
        return (index.h(index.Host, { key: '70ada828e8cf541ab3b47f94b7e56ce34114ef88', class: index.getIonMode(this) }, index.h("slot", { key: 'c43e105669d2bae123619b616f3af8ca2f722d61' })));
    }
};
